    ...
    foreach($data as $user){?>
      ...
      <form class="" action="delete.php" method="post">
        <div class="input-field col s1 offset-l1">
          <input id="icon_prefix" class="cyan-text" type="text" name="id">
          <label for="icon_prefix" class="cyan-text">ID</label>
        </div>
        <button id="send" class="col l2 btn cyan accent-1 waves-effect waves-light btn black-text" type="submit" name="delete">
